...
/**
 * Scroll-to-expand media hero. NOTE: this component hijacks window wheel/scroll/
 * touch events, so it conflicts with Lenis smooth scroll and must own the whole
 * page (mount it on a dedicated route with Lenis disabled). It is intentionally
 * NOT wired into the main single-page flow.
 */
